...
class _cs_matrix(_data_matrix, _minmax_mixin, IndexMixin):
    ...
    def _mul_vector(self, other):
        ...
        fn = getattr(nb_sparsetools, self.format + '_matvec')
        # print( self.format + '_matvec')
        result = fn(M, N, self.indptr, self.indices, self.data, other)
    ...
    def _binopt(self, other, op):
        ...
        print('self.format + op + self.format: ',
              self.format + op + self.format)
        print('fn: ', fn)
