...
from nb_compressed import _cs_matrix


class csr_matrix_nb(_cs_matrix):
    """
    ...
    def __iter__(self):
        ...
        for i1 in self.indptr[1:]:
            ...
            yield csr_matrix_nb((data, indices, indptr), shape=shape, copy=True)
            i0 = i1
    ...
    def getrow(self, i):
        ...
        return csr_matrix_nb((data, indices, indptr), shape=(1, N),
    ...
    def getcol(self, i):
        ...
        return csr_matrix_nb((data, indices, indptr), shape=(M, 1),
                          dtype=self.dtype, copy=False)
    ...
    def _get_intXslice(self, row, col):
        ...
        return csr_matrix_nb((row_data, row_indices, row_indptr), shape=shape,
                          dtype=self.dtype, copy=False)
...
def isspmatrix_csr(x):
    ...
    False
    """
    return isinstance(x, csr_matrix_nb)
